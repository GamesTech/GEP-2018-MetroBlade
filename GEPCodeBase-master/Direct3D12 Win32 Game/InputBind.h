...
*           Input
*
*  @brief Definition for InputBind as well as other key constants.
*
*  @section Description
*  Represents a keybinding fro use in the input system.
*/
...
/*
*  Alias for global use in the InputSystem. 
*  Allows for all forms of input to be recognised.
*/
using MetroBrawlKeyInput = int; 
...
enum MetroBrawlInputActions
{
	...
	KEY_MOUSE_SCROLLWHEEL = 0x102,

	// Controller inputs
	KEY_CONTROLLER_A = 0x103,
	KEY_CONTROLLER_B = 0x104,
	KEY_CONTROLLER_X = 0x105,
	KEY_CONTROLLER_Y = 0x106,
	KEY_CONTROLLER_DPAD_UP = 0x107,
	...
	KEY_CONTROLLER_LEFT_THUMB_X = 0x10D,
	KEY_CONTROLLER_LEFT_THUMB_Y = 0x10E,
	KEY_CONTROLLER_RIGHT_THUMB_X = 0x10F,
	KEY_CONTROLLER_RIGHT_THUMB_Y = 0x110,
	KEY_CONTROLLER_LEFT_SHOLDER = 0x111,
	KEY_CONTROLLER_RIGHT_SHOLDER = 0x112,
};
